...
String parameterToString(dynamic value) {
  ...
  if (value is AttendeeRole) {
    return AttendeeRoleTypeTransformer().encode(value).toString();
  }
  if (value is AttendeeStatus) {
    return AttendeeStatusTypeTransformer().encode(value).toString();
  }
  if (value is BlockType) {
    return BlockTypeTypeTransformer().encode(value).toString();
  }
  if (value is ReminderMethod) {
    return ReminderMethodTypeTransformer().encode(value).toString();
  }
