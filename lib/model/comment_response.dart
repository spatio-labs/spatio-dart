...
class CommentResponse {
  ...
  @override
  String toString() => 'CommentResponse[comment=$comment]';
  ...
  static CommentResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'comment'), 'Required key "CommentResponse[comment]" is missing from JSON.');
        assert(json[r'comment'] != null, 'Required key "CommentResponse[comment]" has a null value in JSON.');
        return true;
      }());
