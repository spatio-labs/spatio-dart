...
class AppListResponse {
  ...
  @override
  String toString() => 'AppListResponse[apps=$apps, total=$total]';
  ...
  static AppListResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'apps'), 'Required key "AppListResponse[apps]" is missing from JSON.');
        return true;
      }());

      return AppListResponse(
        apps: App.listFromJson(json[r'apps']),
