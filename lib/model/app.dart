...
class App {
  ...
  @override
  String toString() => 'App[id=$id, name=$name, description=$description, projectPath=$projectPath, icon=$icon, color=$color, createdAt=$createdAt, updatedAt=$updatedAt]';
  ...
  static App? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'id'), 'Required key "App[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "App[id]" has a null value in JSON.');
        return true;
      }());
