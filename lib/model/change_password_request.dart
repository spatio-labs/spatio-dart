...
class ChangePasswordRequest {
  ...
  static ChangePasswordRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'newPassword'), 'Required key "ChangePasswordRequest[newPassword]" is missing from JSON.');
        assert(json[r'newPassword'] != null, 'Required key "ChangePasswordRequest[newPassword]" has a null value in JSON.');
        return true;
      }());
